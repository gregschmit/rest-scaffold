...
function addRecordActionHelpers(scaffold) {
  ...
  scaffold.renderDetailView = function (renderDetailElement) {
    ...
    /* add header */
    table = '<span class="rest-scaffold-page-head">Update ' + this.recordTitle + "</span>" + table
    ...
    table =
      '<tr class="rest-scaffold-page" data-rest-scaffold-ref-pk="' + pk + '">' + table + "</tr>"
  ...
  scaffold.renderActionLinks = function () {
    ...
    if (scaffold.updateForm) {
      recordActions.push('<li><a href="#" data-rest-scaffold-render-update>Update</a></li>')
    }
    /* render detail action */
    recordActions.push('<li><a href="#" data-rest-scaffold-render-detail>Detail</a></li>')
    /* render delete action */
    recordActions.push('<li><a href="#" data-rest-scaffold-delete>Delete</a></li>')
